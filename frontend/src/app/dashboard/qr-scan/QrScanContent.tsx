...
import QrScanTab from "@/frontend/components/dashboard/QrScanTab";

interface Props {
  user: SupabaseUser;
}

export default function QrScanContent({ user }: Props) {
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Upload a QR code image to instantly reveal hidden URLs, detect phishing, and assess scam risk before clicking.
              </p>
            </div>
